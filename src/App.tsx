        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-4 text-gray-700">
            <a
              ...
              className="relative px-2 py-0.5 rounded z-10 overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[#333]/20 before:rounded before:skew-y-[-2deg] before:scale-x-0 before:origin-left before:transition-transform before:duration-300 hover:before:scale-x-100"
            >
              <span className="relative z-10">GitHub</span>
            </a>
            <a
              href="https://www.linkedin.com/in/mkdesilva/"
              className="relative px-2 py-0.5 rounded z-10 overflow-hidden before:content-[''] before:absolute before:inset-0 before:bg-[#0077B5]/20 before:rounded before:skew-y-[-2deg] before:scale-x-0 before:origin-left before:transition-transform before:duration-300 hover:before:scale-x-100"
            >
